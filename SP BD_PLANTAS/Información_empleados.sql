CREATE DEFINER=`root`@`localhost` PROCEDURE `Información_empleado`(IN id_empleado int)
BEGIN
    ...
    COALESCE(e.fecha_salida,0) as 'Fecha Salida', a1.nombre as 'Supervisor',   d.nombre as 'Departamento' , te.nombre 'Tipo de empleado'
    FROM empleado e
